    ...
    return (
        <section className="flex flex-col">
            <div className="flex justify-between items-end">
                <div>
                    <h2 className="text-xl font-semibold text-secondary-dark">Your Works</h2>
                    <p className="text-sm text-secondary-dark">Manage your writing projects</p>
                </div>
            ...
            <div className="border-b-2 border-[#917F74]/39 mt-2"></div>
                ...
                {(movies.length  > 0)
                ?   
                <div className="flex overflow-x-scroll w-full gap-8 pt-6 pl-1 h-72" ref={scrollContainerRef}>
                    {movies.map((src, index) => (
                        <div key={index} className="group flex flex-col gap-3 ">
                            ...
                            />
                            <div>
                                <h3 className="text-md text-secondary-dark group-hover:font-semibold">Untitled Book</h3>
                                <p className="text-primary-base text-xs group-hover:font-semibold">Drafts 15</p>
                            </div>
                        </div>
                    ))}
                </div>
                ...
                <div className="flex flex-col gap-3 items-center justify-center w-full h-64">
                    <Image src={no_books} alt="Girl uploading pages from her phone in a cloud holding a book" width={100} height={100}/>
                    <div className="text-center">
                        <h3>No books yet</h3>
                        <p>Every great story starts with a blank page. readt to write yours?</p>
                    </div>
                    <Button color="secondary" endIcon={<CgMathPlus />}>Add New Button</Button>
                </div>
                }
        </section>
    )
